...
public record TranscriptionResult(
    ...
    public static TranscriptionResult success(String text, String language, Double languageProbability) {
        return new TranscriptionResult(true, null, text, language, languageProbability, null, null, null, null);
    }

    public static TranscriptionResult failure(String errorCode, String errorMessage) {
        return new TranscriptionResult(false, null, null, null, null, null, null, errorCode, errorMessage);
    }
}
