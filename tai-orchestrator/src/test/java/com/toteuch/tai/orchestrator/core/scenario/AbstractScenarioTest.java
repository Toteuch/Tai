...
abstract class AbstractScenarioTest {
    ...
    @Autowired
    protected TaiEventPublisher eventPublisher;
    @Autowired
    ...
    protected void publishSttAccepted(String correlationId, String text) {
        eventPublisher.publish(new SttTranscriptAcceptedEvent(
            UUID.randomUUID().toString(),
            Instant.now(),
            correlationId,
    ...
    protected void publishSttUnintelligible(String correlationId) {
        eventPublisher.publish(new SttTranscriptUnintelligibleEvent(
            UUID.randomUUID().toString(),
            Instant.now(),
            correlationId,
            EventSource.STT_SERVICE,
    ...
    protected void publishSttNoise(String correlationId) {
        eventPublisher.publish(new SttTranscriptNoiseEvent(
            UUID.randomUUID().toString(),
            Instant.now(),
            correlationId,
            EventSource.STT_SERVICE,
