...
import com.toteuch.tai.taiorchestrator.core.handler.inbound.llm.LlmResponseCompletedEventHandler;
import com.toteuch.tai.taiorchestrator.core.handler.inbound.llm.LlmResponseFailedEventHandler;
...
class LlmInboundEventHandlersTest extends AbstractHandlerTest {
    ...
    void completed_response_for_active_turn_should_publish_assistant_reply_accepted_event() {
        ...
        handler.handle(new LlmResponseCompletedEvent(
    ...
    void failed_response_for_active_turn_should_publish_assistant_reply_failed_event() {
        ...
        handler.handle(new LlmResponseFailedEvent(
            UUID.randomUUID().toString(),
            Instant.now(),
            "corr-2",
            EventSource.LLM_SERVICE,
