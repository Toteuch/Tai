...
public class TtsPiperProperties {
    ...
    public static class Orchestrator {
        ...
        public Callbacks getCallbacks() { return callbacks; }
        public void setCallbacks(Callbacks callbacks) { this.callbacks = callbacks; }
        ...
        public static class Callbacks {
            ...
            public String getPlaybackStartedPath() { return playbackStartedPath; }
            public void setPlaybackStartedPath(String playbackStartedPath) { this.playbackStartedPath = playbackStartedPath; }
            public String getPlaybackCompletedPath() { return playbackCompletedPath; }
            public void setPlaybackCompletedPath(String playbackCompletedPath) { this.playbackCompletedPath = playbackCompletedPath; }
            public String getPlaybackFailedPath() { return playbackFailedPath; }
            public void setPlaybackFailedPath(String playbackFailedPath) { this.playbackFailedPath = playbackFailedPath; }
        }
    }
    ...
    public static class Piper {
        ...
        public long getProcessTimeoutMs() { return processTimeoutMs; }
        public void setProcessTimeoutMs(long processTimeoutMs) { this.processTimeoutMs = processTimeoutMs; }
    }
}
